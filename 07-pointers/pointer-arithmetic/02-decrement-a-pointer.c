...
void main(){
    ...
    for (int i = (sizeof(marks)/4 - 1); i >= 0 ; i--)
    {
        ...
        // Since values in an array are stored in continuou memory locations, decrementing the memory address by 1 can give us the memory address of the next element of the array.
        mp--;
    }
}