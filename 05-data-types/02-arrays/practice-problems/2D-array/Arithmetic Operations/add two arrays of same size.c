...
void main()
{
    ...
    // Taking the elements of array 1 as input from the user
    ...
    // Taking the elements of array 2 as input from the user
    ...
    // Adding the matrices or array 1 and array 2 and appending the results on the specified position in the array 3 or another matrix 
    for (int i = 0; i < size; i++)
    {
        for (int j = 0; j < size; j++)
        {
            ...
            // summing the individual elements to get the element for the result matrix
            sum = a + b;
